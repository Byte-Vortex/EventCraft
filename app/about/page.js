        ...
        <motion.div
          ...
          <div className="max-w-3xl mx-auto py-16">
            <p className="text-lg mb-6 text-justify">
              ...
              level of excitement and personalization to your events.
            </p>
            <p className="text-lg mb-6">
              Founded in 2024, we&apos;ve quickly become the go-to choice for those seeking to add a touch of creativity and
              interactivity to their gatherings. Whether it&apos;s a corporate event, wedding, or birthday party, we tailor
              our services to meet your specific needs and exceed your expectations.
            </p>
            <p className="text-lg">
              Our team of professionals is passionate about what they do and committed to ensuring that every event we
